...
const allComponents: OverviewItem[] = [
  ...
  },
  {
    ...
    description: '流式缓存、LaTeX、动画与企业级消毒',
  ...
  },
  {
    id: 'x-card',
    category: '工具',
    title: 'XCard A2UI 动态卡片',
    description: 'Agent 结构化命令驱动的动态界面（v0.9）',
  ...
  },
  {
    ...
    category: '工具',
    title: 'useXChat',
    description: '聊天数据管理（conversationKey / abort）',
