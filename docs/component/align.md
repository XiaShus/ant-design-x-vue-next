...
| --- | --- | --- | --- | --- |
| 通用 | Bubble | ✅ | ✅（含 System / Divider / List `role`+语义 `root/scroll/bubble/system/divider` / `contentRender`+`InfoType` / `extra` / avatar BubbleSlot / streaming / typing） | [文档](/component/bubble) |
