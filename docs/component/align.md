...
| 反馈 | Actions | ✅ | ✅（含 `items[].subItems`→`children` 别名；Copy / Feedback / Item / Audio 预设 API 文档；`fadeIn`/`fadeInLeft`、`dropdownProps`、`outlined`/`filled`、`classNames/styles` root/item/itemDropdown、`nativeElement` ref） | [文档](/component/actions) |
