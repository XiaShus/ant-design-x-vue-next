...
| --- | --- | --- | --- | --- |
| 通用 | Bubble | ✅ | ✅（含 System / Divider / editable / streaming / `contentRender`+`InfoType` / `typing.keepPrefix` / `onTyping`） | [文档](/component/bubble) |
...
| 反馈 | Actions | ✅ | ✅（含 Copy / Feedback / Item / Audio、`fadeIn`/`fadeInLeft`、`dropdownProps`） | [文档](/component/actions) |
